...
import { 
  ...
  BookOpen, GraduationCap, CheckCircle2, Film, User, Volume2
} from "lucide-react";
        ...
        <AnimatePresence mode="wait" custom={direction}>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-0">
              ...
              {/* LEFT / TOP: STUDENT IMAGE & PHOTO CARD */}
              <div className="md:col-span-5 bg-gradient-to-br from-slate-900 via-slate-850 to-blue-950 text-white relative min-h-[260px] md:min-h-[380px] flex flex-col justify-between p-6 overflow-hidden">
                
                {/* Background Decorator */}
                <div className="absolute -top-16 -right-16 w-48 h-48 bg-blue-500/10 rounded-full blur-3xl pointer-events-none" />

                {/* Top Badge: Exam or Category */}
                <div className="flex items-center justify-between z-10">
                  <span className="px-3 py-1 rounded-full text-[10px] sm:text-xs font-mono font-bold uppercase tracking-wider bg-blue-600/30 text-blue-200 border border-blue-400/30 backdrop-blur-md">
                    {activeItem.examination || "NEET / JEE"}
                  </span>
                ...
                {/* Center Student Photo / Avatar Visual */}
                <div className="my-auto py-4 flex flex-col items-center justify-center text-center z-10">
                  <div className="relative group/avatar">
                    ...
                    {!imageErrorMap[activeItem.id] && activeItem.image ? (
                      ...
                      /* Fallback styled avatar with gradient initials */
                  ...
                  <h3 className="font-sans font-extrabold text-xl sm:text-2xl text-white mt-4 tracking-tight leading-tight">
                    {activeItem.name}
                  </h3>

                  {activeItem.parentStudentName && (
                    <span className="text-xs font-mono text-blue-200/80 mt-0.5 block">
                ...
                {activeItem.achievement && (
                  <div className="z-10 bg-white/10 backdrop-blur-md rounded-2xl p-2.5 sm:p-3 border border-white/15 text-center">
              ...
              {/* RIGHT / BOTTOM: ACADEMIC METRICS & QUOTE */}
              <div className="md:col-span-7 p-6 sm:p-8 flex flex-col justify-between space-y-6">
                
                {/* Header & Badges */}
                <div className="space-y-4">
                  
                  {/* Scores Grid for Topper Variant */}
                ...
                <div className="pt-2 flex flex-wrap items-center justify-between gap-3 border-t border-slate-100">
                  <div className="text-xs text-slate-500 font-mono">
                    <span>Verified Result</span> • <span className="text-blue-600 font-semibold">{activeItem.examination || "V.S.R.P.T"}</span>
                  </div>
